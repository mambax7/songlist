<{if $block}>
    ...
    <{/if}>
    <{if $block.genres|is_array && count($block.genres) > 0 }>
    <div style='font-size:0.85em; clear:both;'>
    ...
    <{/if}>
    <{if $block.albums_array|is_array && count($block.albums_array) > 0}>
    <div style='font-size:0.85em; clear:both;'>
    ...
    <{/if}>
    <{if $block.songs_array|is_array && count($block.songs_array) > 0 }>
    <div style='font-size:0.85em; clear:both;'>
