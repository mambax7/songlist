...
define('_MI_SONGLIST_DESC', 'Karaoke Songlist - a module for keeping Karaoke song lists and ranking of them.');
...
define('_MI_SONGLIST_STYLESHEET', '/modules/songlist/assets/css/songlist.css');
...
//1.14
//Menu
define('_MI_SONGLIST_MENU_HOME', 'Home');
define('_MI_SONGLIST_MENU_01', 'Admin');
define('_MI_SONGLIST_MENU_ABOUT', 'About');


//Config
define('MI_SONGLIST_EDITOR_ADMIN', 'Editor: Admin');
define('MI_SONGLIST_EDITOR_ADMIN_DESC', 'Select the Editor to use by the Admin');
define('MI_SONGLIST_EDITOR_USER', 'Editor: User');
define('MI_SONGLIST_EDITOR_USER_DESC', 'Select the Editor to use by the User');
